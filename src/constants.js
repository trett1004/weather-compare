...
export const WEATHER_ICONS = {
  0: { dayIcon: clearDayIcon, nightIcon: clearNightIcon, description: "clear sky" },
  1: { dayIcon: mostlyClearDayIcon, nightIcon: mostlyClearNightIcon, description: "mainly clear" },
  2: { dayIcon: partlyCloudyDayIcon, nightIcon: partlyCloudyNightIcon, description: "partly cloudy" },
  3: { dayIcon: overcastDayIcon, nightIcon: overcastNightIcon, description: "overcast" },
  45: { dayIcon: fogIcon, nightIcon: fogIcon, description: "fog" },
  48: { dayIcon: fogIcon, nightIcon: fogIcon, description: "depositing rime fog" },
  51: { dayIcon: partlyCloudyDayDrizzleIcon, nightIcon: partlyCloudyNightDrizzleIcon, description: "light drizzle" },
  53: { dayIcon: overcastDayDrizzleIcon, nightIcon: overcastNightDrizzleIcon, description: "moderate drizzle" },
  55: { dayIcon: extremeDayDrizzleIcon, nightIcon: extremeNightDrizzleIcon, description: "dense drizzle" },
  56: { dayIcon: partlyCloudyDaySleetIcon, nightIcon: partlyCloudyNightSleetIcon, description: "light freezing drizzle" },
  57: { dayIcon: overcastDaySleetIcon, nightIcon: overcastNightSleetIcon, description: "dense freezing drizzle" },
  61: { dayIcon: mostlyClearDayRainIcon, nightIcon: mostlyClearNightRainIcon, description: "slight rain" },
  63: { dayIcon: overcastDayRainIcon, nightIcon: overcastNightRainIcon, description: "moderate rain" },
  65: { dayIcon: extremeDayRainIcon, nightIcon: extremeNightRainIcon, description: "heavy rain" },
  66: { dayIcon: partlyCloudyDaySleetIcon, nightIcon: partlyCloudyNightSleetIcon, description: "light freezing rain" },
  67: { dayIcon: overcastDaySleetIcon, nightIcon: overcastNightSleetIcon, description: "heavy freezing rain" },
  71: { dayIcon: mostlyClearDaySnowIcon, nightIcon: mostlyClearNightSnowIcon, description: "slight snowfall" },
  73: { dayIcon: overcastDaySnowIcon, nightIcon: overcastNightSnowIcon, description: "moderate snowfall" },
  75: { dayIcon: extremeDaySnowIcon, nightIcon: extremeNightSnowIcon, description: "heavy snowfall" },
  77: { dayIcon: snowflakeIcon, nightIcon: snowflakeIcon, description: "snow grains" },
  80: { dayIcon: partlyCloudyDayRainIcon, nightIcon: partlyCloudyNightRainIcon, description: "slight rain showers" },
  81: { dayIcon: overcastDayRainIcon, nightIcon: overcastNightRainIcon, description: "moderate rain showers" },
  82: { dayIcon: extremeDayRainIcon, nightIcon: extremeNightRainIcon, description: "violent rain showers" },
  85: { dayIcon: partlyCloudyDaySnowIcon, nightIcon: partlyCloudyNightSnowIcon, description: "slight snow showers" },
  86: { dayIcon: overcastDaySnowIcon, nightIcon: overcastNightSnowIcon, description: "heavy snow showers" },
  95: { dayIcon: thunderstormsDayIcon, nightIcon: thunderstormsNightIcon, description: "thunderstorm" },
  96: { dayIcon: thunderstormsDayHailIcon, nightIcon: thunderstormsNightHailIcon, description: "thunderstorm with slight hail" },
  99: { dayIcon: thunderstormsExtremeDayHailIcon, nightIcon: thunderstormsExtremeNightHailIcon, description: "thunderstorm with heavy hail" },
};
